...
public class Top_Arrow : MonoBehaviour
{
    //選択ボタン
    ...
    public void AjustPosition(GameObject newPos)
    {
        ...
        transform.position = new Vector3(pos.x + ConvertAspect.GetWidth(offset.x)+offset.x, pos.y + ConvertAspect.GetHeight(offset.y)+offset.y, pos.z + offset.z);
